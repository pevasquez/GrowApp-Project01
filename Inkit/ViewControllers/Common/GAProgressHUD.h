...
@protocol GAProgressHUDDelegate;

/////////////////////////////////////////////////////////////////////////////////////////////

typedef enum {
    /** Progress is shown using an UIActivityIndicatorView. This is the default. */
    GAProgressHUDModeIndeterminate,
    /** Progress is shown using a MBRoundProgressView. */
    GAProgressHUDModeDeterminate,
    /** Shows a custom view */
    GAProgressHUDModeCustomView
} GAProgressHUDMode;
 ...
 */
@interface GAProgressHUD : UIView {
...
@property (nonatomic, assign)id <GAProgressHUDDelegate> delegate;
 ...
 */
@property (assign) GAProgressHUDMode mode;
 ...
 */
//@property (assign) id <GAProgressHUDDelegate> delegate;
...
@protocol GAProgressHUDDelegate <NSObject>
 ...
 */
- (void)hudWasHidden:(GAProgressHUD *)hud;
 ...
 */
@interface GARoundProgressView : UIView {
@private
    float _progress;
}
